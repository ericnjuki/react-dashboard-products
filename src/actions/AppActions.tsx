...
const getProductById = (id: number) => (dispatch: Dispatch) => {
  try {
    axios
...
const putProductById = (id: number) => (dispatch: Dispatch) => {
  try {
    axios.get(`${API.putProduct}/${id}`).then((result) => {
...
const getTRL = (id: number) => (dispatch: Dispatch) => {
  try {
    axios.get(`${API.getTRL}/${id}`).then((result) => {
...
const getConfig = (id: number) => (dispatch: Dispatch) => {
  try {
    axios.get(`${API.getConfig}/${id}`).then((result) => {
